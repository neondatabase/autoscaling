...
// vm-builder --src alpine:3.20 --dst vm-alpine:dev --file vm-alpine.qcow2
...
var (
	...
	srcImage  = flag.String("src", "", `Docker image used as source for virtual machine disk image: --src=alpine:3.20`)
	dstImage  = flag.String("dst", "", `Docker image with resulting disk image: --dst=vm-alpine:3.20`)
