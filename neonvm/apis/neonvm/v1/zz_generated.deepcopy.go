...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtiofsSource) DeepCopyInto(out *VirtiofsSource) {
	*out = *in
	out.SizeLimit = in.SizeLimit.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtiofsSource.
func (in *VirtiofsSource) DeepCopy() *VirtiofsSource {
	if in == nil {
		return nil
	}
	out := new(VirtiofsSource)
