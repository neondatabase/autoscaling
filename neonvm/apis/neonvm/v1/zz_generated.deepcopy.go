...
func (in *IPPoolSpec) DeepCopyInto(out *IPPoolSpec) {
	*out = *in
	...
	if in.QuarantinedOffsets != nil {
		in, out := &in.QuarantinedOffsets, &out.QuarantinedOffsets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.QuarantinedOffsetsPending != nil {
		in, out := &in.QuarantinedOffsetsPending, &out.QuarantinedOffsetsPending
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	in.QuarantineStartTime.DeepCopyInto(&out.QuarantineStartTime)
}
