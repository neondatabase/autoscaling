...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImplicitDiskSource) DeepCopyInto(out *ImplicitDiskSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImplicitDiskSource.
func (in *ImplicitDiskSource) DeepCopy() *ImplicitDiskSource {
	if in == nil {
		return nil
	}
	out := new(ImplicitDiskSource)
