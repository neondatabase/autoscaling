...
func (r *VMReconciler) SetupWithManager(mgr ctrl.Manager, retryChan *reqchan.RequestChannel, forceRetryNonRetried bool) (ReconcilerWithMetrics, error) {
	cntrlName := "virtualmachine"

	var submitRequest func(reconcile.Request)
	if forceRetryNonRetried {
