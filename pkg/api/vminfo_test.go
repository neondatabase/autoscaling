...
func TestFormatting(t *testing.T) {
	...
	defaultFormat := "{Name:foo Namespace:bar Cpu:{Min:1000 Max:5000 Use:3000} Mem:{Min:2 Max:6 Use:4 SlotSize:1Gi} ScalingConfig:&{LoadAverageFractionTarget:0.7} AlwaysMigrate:false ScalingEnabled:true}"
