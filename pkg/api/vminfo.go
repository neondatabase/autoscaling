...
type ScalingConfig struct {
	...
	// MemoryUsageFractionTarget sets the maximum fraction of current memory that we'd like to allow
	// to be allocated (exactly MemTotal - MemAvailable, or roughly the memory that postgres has
	// allocated [notably excluding LFC]).
	...
	// MemoryTotalFractionTarget sets the maximum fraction of current memory that we'd like to allow
